<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Coordinator.aspx.cs" Inherits="Coordinator" %>
    ...
    <form id="form1" runat="server">
     ...
     <div class="container bgt well">
            <div class="row">
                ...
                <div class="col-md-8 text-center">
                  ...
                  <div class="row">
                    ...
                    <br />
                    <asp:button runat="server" OnClick="lgout_Click" OnClientClick="lgout_Click" Text="Log out" class="btn btn-danger"/>
                </div>
            ...
            <div class="tab-content">
                ...
                <div id="menu2" class="tab-pane fade">
                    <div class="text-center">
                        ...
                        <br />
                        <asp:Button ID="Button1" runat="server" Text="CHANGE PASSWORD"  CssClass="btn btn-success" />
         ...
         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
             <ContentTemplate>
                 <asp:TextBox ID="TextBox4" placeholder="Enter Id to get Details of students" runat="server"></asp:TextBox>
                 <asp:Button ID="Button2" CssClass="btn btn-info" runat="server" Text="Get Info" OnClick="Button2_Click" OnClientClick="Button2_Click" />
